...
- [Product-Focused Overview](#product-focused-overview)
- [Live Storybooks and Chromatic Projects](#live-storybooks-and-chromatic-projects)
...
Accretion UI demonstrates a scalable model for design systems:

- One source of truth for component behavior, style, and accessibility in `@accretion_ui/core`.
- Auto-generated framework wrappers (React and Angular) from that same core.
- Separate npm packages by framework/version so product teams adopt with minimal friction.
- Consistent visual and interaction results across app stacks.

This means teams do not manually hand-build the same component multiple times per framework. Wrapper output is generated by Stencil build tooling and then published for direct installation.

## Live Storybooks and Chromatic Projects

| Framework Target | Storybook | Chromatic Project |
|---|---|---|
| React (`@accretion_ui/react`) | [View Storybook](https://69a694b696baf333e562e9f1-qnguwtzjwu.chromatic.com/) | [View Chromatic](https://www.chromatic.com/setup?appId=69a694b696baf333e562e9f1) |
| Angular 18 (`@accretion_ui/angular_18`) | [View Storybook](https://69a69540931282436807583e-petaibmswl.chromatic.com/) | [View Chromatic](https://www.chromatic.com/setup?appId=69a69540931282436807583e) |
| Angular 21 (`@accretion_ui/angular_21`) | [View Storybook](https://69a69585a3c2c8accf671d8d-nmseudrlun.chromatic.com/) | [View Chromatic](https://www.chromatic.com/setup?appId=69a69585a3c2c8accf671d8d) |

Each Storybook represents a different wrapper target, but all are backed by the same core web component implementation.
